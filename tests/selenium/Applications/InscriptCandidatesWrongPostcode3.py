...
class InscriptCandidatesWrongPostcode3(TestApplications):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__("Test d'inscription d'un candidat - code postal invalide 3")
    ...
    def run(self):
        ...
        try:    
            ...
            self.setCandidateForm(
                ...
                self.APP_CANDIDATES_WRONG_POSTCODE_3
            )
