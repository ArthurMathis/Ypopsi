...
class InscriptCandidatesWrongFirstname2(TestApplications):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__("Test d'inscription d'un candidat - prénom invalide 2")
    ...
    def run(self):
        ...
        try:    
            ...
            self.setCandidateForm(
                ...
                self.APP_CANDIDATES_WRONG_NAME_2,
