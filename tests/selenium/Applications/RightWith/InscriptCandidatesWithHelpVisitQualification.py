...
class InscriptCandidatesWithHelpVisitQualification(TestApplications):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__("Test d'inscription d'un candidat - avec une aide, un diplome et une visite")
