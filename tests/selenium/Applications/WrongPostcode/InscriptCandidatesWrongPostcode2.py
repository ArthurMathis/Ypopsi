...
class InscriptCandidatesWrongPostcode2(TestApplications):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__("Test d'inscription d'un candidat - code postal invalide 2")
    ...
    def run(self):
        ...
        try:    
            ...
            self.setCandidateForm(
                ...
                self.APP_CANDIDATES_WRONG_POSTCODE_2
            )
