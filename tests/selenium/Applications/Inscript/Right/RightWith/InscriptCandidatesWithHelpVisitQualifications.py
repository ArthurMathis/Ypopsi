...
class InscriptCandidatesWithHelpVisitQualifications(TestApplications):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__("Test d'inscription d'un candidat - avec une aide, des diplomes et une visite")
    ...
    def run(self):
        ...
        try:    
            ...
            self.setHelps(driver, self.APP_CANDIDATES_HELP)
