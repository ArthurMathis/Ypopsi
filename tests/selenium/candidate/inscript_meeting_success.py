    ...
    def run(self):
        ...
        try:
            ...
            WebDriverWait(driver, 10).until(
                EC.url_contains("index.php?candidates=")  # Vérifie que l'URL contient "index.php?candidates="
            )
            print(f"{self.VERT}Le rendez-vous a été enregistré avec succès.{self.RESET}")
