...
class InscriptRating5(TestCandidates):
    # * CONSTRUCTOR * #
    def __init__(self):
        """
        Initialise le test avec un nom descriptif
        """
        super().__init__("Test d'inscription de la notation 5/5 (candidat nécessaire)")
    ...
    def run(self):
        ...
        try:
            ...
            self.setRating(driver, self.APP_CANDIDATES_RATING_5)
