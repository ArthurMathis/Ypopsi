...
filtrer.addEventListener('click', () => {
    ...
    if(filtrerIsVisible) {
        ...
        newBouton.addEventListener('click', () => {
            ...
            try {
                const criteres = listManipulation.recoverFields(champs_infos);
                const criteres_statut = listManipulation.recoverCheckbox(champs_statut);
                ...
                if(criteres.length === 0  && criteres_statut.criteres.length === 4) {
                    ...
                    candidatures_selection = listManipulation.multiFilter(candidatures_selection, criteres, criteres_statut);
