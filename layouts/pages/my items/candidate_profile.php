...
<aside>
    <div class="aside-wrapper">
        <header>
            <h2>
                <?= $candidate->getCompleteName() ?>
            </h2>    

            <h3>
                <?= $applications[0]['type_de_contrat']; ?>
            </h3>
        ...
        <?php if(AuthMiddleware::isUserOrMore()): ?>
            <?php if(!empty($candidate->getEmail())): ?>
                <a 
                    ...
                    href="mailto:<?= $candidate->getEmail() ?>"
                >
                    <p>
                        Contacter
                    </p>
                    ...
                    <img 
                        src="<?= APP_PATH ?>\layouts\assets\img\logo\white-paperplane.svg" 
                        alt=""
                    >
                </a>
            <?php endif ?>
            ...
            <a 
                class="action_button form_button" 
                href="<?= APP_PATH ?>/candidates/edit/<?= $candidate->getId() ?>"
            >
                <p>
                    Modifier
                </p>
                ...
                <img 
                    src="<?= APP_PATH ?>\layouts\assets\img\logo\blue\edit.svg"    
                    alt=""
                >
            </a>  
        <?php endif ?>    
